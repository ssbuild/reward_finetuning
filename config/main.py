...
if global_args["enable_lora"]:
    from config.reward_config_lora import train_info_args,train_info_args_hf,train_info_args_colossalai,train_info_args_ac,train_model_config
elif global_args["enable_ptv2"]:
    raise NotImplemented
else:
    from config.reward_config import train_info_args,train_info_args_hf,train_info_args_colossalai,train_info_args_ac,train_model_config
